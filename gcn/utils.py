...
def load_data(is_single):
    ...
    features, labels, adj1, idx_train = extract_matrix_v2.get_data_from_file_test('/home/hq-lg/gcn/gcn/raw/text_1.txt', '/home/hq-lg/gcn/gcn/raw/pos_1.txt', is_single=is_single)

    # train
    # features, labels, adj1, idx_train = extract_matrix_v2.get_data_from_file('/home/hq-lg/gcn/gcn/raw/text_1.txt', '/home/hq-lg/gcn/gcn/raw/pos_1.txt')
